...
6. **⚠️ Geldspielrecht — der wichtigste Punkt:** Polymarket steht seit 11/2024 auf der **GESPA-Sperrliste** (Schweizer ISPs DNS-blocken polymarket.com); Kalshi führt die Schweiz als Restricted Jurisdiction. **Werbung für nicht bewilligte Geldspiele ist verboten** (BGS Art. 74 Abs. 3, Bussen bis CHF 500'000), und schon **Verlinkung kann als Werbung gelten** — 2025 liefen Strafverfahren gegen Influencer wegen Online-Casino-Promo. Konsequenz für die Site:
   - Neutrale Daten-/Research-Darstellung: vertretbare Position, aber **keine** Referral-/Affiliate-Links, keine "Trade now"-CTAs, keine Sign-up-Funnels.
   - Die "Open market"-Buttons sind aktuell neutrale Quellen-Links. Vor dem öffentlichen Launch: **1–2 h Beratung bei einem Schweizer Anwalt** zu BGS Art. 74 (Links behalten vs. entfernen) — ca. CHF 300–600. Das ist der einzige Punkt, den Code nicht lösen kann.
...
| Kalshi trade-api/v2 | Basic-Tier 20 Reads/s (Token-Bucket); public Reads ohne Auth | **⚠️ Risiko:** Die "Kalshi Data Terms" verbieten ohne schriftliche Erlaubnis das öffentliche Re-Display/Verbreiten von Kalshi-Daten ("personal use, non-commercial"). Das separate Developer Agreement (kalshi.com/developer-agreement) war automatisiert nicht abrufbar. **Vor Launch im Browser lesen und im Zweifel Kalshi anschreiben.** Größtes ToS-Risiko des Projekts. ([Data Terms PDF](https://kalshi-public-docs.s3.amazonaws.com/kalshi-data-terms-of-service.pdf), [Rate Limits](https://docs.kalshi.com/getting_started/rate_limits)) |
