...
function renderIdentity(T, d) {
  ...
  if (id.activity_error) tags.push('<span style="' + M + '; font-size:var(--t-micro); letter-spacing:.08em; color:var(--warn); border:1px solid rgba(var(--warn-rgb),.35); border-radius:var(--r-control); padding:2px 7px">ACTIVITY NOT READ</span>');
  return '<div style="' + KARTE + '; padding:16px 18px; position:relative; overflow:hidden">'
    ...
    + '<div style="' + M + '; font-size:var(--t-micro); color:var(--ink-3); margin-top:5px">' + (id.activity_error
