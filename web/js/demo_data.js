...
export const STUDIES = [
  ...
  { tab: 'Methodology', title: 'Method, guardrails and audit', stamp: 'version 4.2', note: 'What each score means, what it does not mean, and the hash chain that shows nothing was edited after publication.', chart: 'AUDIT ENTRIES PER WEEK', stats: [['HASH CHAIN','intact','7,412 entries'],['BANNED PHRASES','41','checked on publish'],['SCORES DEFINED','4','one scorecard'],['LAST AUDIT','2 days ago','automated']] }
];
